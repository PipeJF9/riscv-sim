            ...
            switch (mapping.type) {
                ...
                case "I":
                    ...
                    if (mapping.funct3 === funct3_i) {
                        ...
                        const imm_i = parseInt(binary.slice(0, 12), 2) << 20 >> 20; // Sign-extend
                ...
                case "S":
                    ...
                    if (mapping.funct3 === funct3_s) {
                        ...
                        const imm_s = parseInt(imm11_5 + imm4_0, 2) << 20 >> 20; // Sign-extend
                ...
                case "B":
                    ...
                    if (mapping.funct3 === funct3_b) {
                        ...
                        const imm_b = parseInt(imm12 + imm11 + imm10_5 + imm4_1 + "0", 2) << 19 >> 19; // Sign-extend
                        return `${mnemonic} ${rs1_b}, ${rs2_b}, ${imm_b}`;
                    }
                    break;
                case "U":
                    const rd_u = regMaph[binary.slice(20, 25)];
                    const imm_u = parseInt(binary.slice(0, 20), 2);
                ...
                case "J":
                    ...
                    const imm_j = parseInt(imm20 + imm19_12 + imm11_j + imm10_1 + "0", 2) << 11 >> 11; // Sign-extend
...
export function translateRISCV(params) {
    ...
    if (params.instruction) {
        ...
        if (mapping && (mapping.type === "S" || 
            (mapping.type === "I" && ["lb", "lh", "lw", "lbu", "lhu"].includes(mnemonic)))) {
